...
class App(tk.Tk):
    ...
    def _build_order(self):
        ...
        label(middle, "选择餐品", "Heading.TLabel").pack(anchor="w", pady=(0, 12))
        ...
        label(middle, "输入菜名搜索 · 双击餐品即可添加", "Muted.TLabel").pack(anchor="w", pady=(0, 8))
        ...
        label(right, textvariable=self.cart_title, style="Heading.TLabel").pack(anchor="w")
        self.order_hint = tk.StringVar()
        label(right, textvariable=self.order_hint, style="Muted.TLabel", padding=(0, 5, 0, 12)).pack(anchor="w")
        ...
        self.checkout_button.pack(fill="x", pady=(0, 8))
        button(right, "取消本桌订单", self.cancel_order).pack(fill="x")
...
class HistoryPage(ttk.Frame):
    def __init__(self, app):
        ...
        self.summary = tk.StringVar()
        label(self, textvariable=self.summary, style="Muted.TLabel").pack(anchor="w", pady=(12, 0))
